defmodule SarthakAdmission.Repo.Migrations.AddStudentTotalMarksTwelveStaging do
  use Ecto.Migration

  def change do
    create table(:student_total_marks_twelve_staging, primary_key: false) do
    ...
    create unique_index(:student_total_marks_twelve_staging, [:token_no])
  end
end
